...
<template>
  <div class="w-full h-full min-h-[400px] relative">
    ...
    <!-- Map Legend -->
    <div class="absolute bottom-20 md:bottom-6 left-3 z-[100] bg-white rounded-xl px-4 py-3.5 shadow-lg text-sm">
      ...
      <div class="flex items-center gap-2.5" :class="{ 'mb-3': true, 'md:mb-0': true }">
      ...
      <div class="md:hidden border-t border-gray-200 pt-3 space-y-2">
